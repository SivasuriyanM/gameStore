...
const FG = "http://localhost:3000/FG.exe";
const HZ = "http://localhost:3000/HZ.exe";
const MH = "http://localhost:3000/MH.exe";
const RC = "http://localhost:3000/Robocop2D3.exe";
const AT = "http://localhost:3000/Ardentryst.exe";
const WN = "http://localhost:3000/Wilkanoid2.exe";
const FA = "http://localhost:3000/FLIPSADVENTURE.exe";
const CS = "http://localhost:3000/CS.exe";
const SB = "http://localhost:3000/StealthBastard.exe";
...
export const Pregames = [
    {
        ...
        link : <button onClick ={()=>{downloadFile(FG)}}>Download</button>
    ...
    },
    {
        ...
        size:"Size : 3.2 MB",
        version : "Version : 1.0(x86)",
        link : <button onClick ={()=>{downloadFile(HZ)}}>Download</button>
    },
    {
        name: "MultiHero",
        image: SGI,
        ...
        size:"Size : 10.1 MB",
        version : "Version : 1.0(x86)",
        link : <button onClick ={()=>{downloadFile(MH)}}>Download</button>
    ...
    },
    {
        ...
        link : <button onClick ={()=>{downloadFile(RC)}}>Download</button>
    },
    {
        name: "Ardentryst",
        image: WBI,
        ...
        link : <button onClick ={()=>{downloadFile(AT)}}>Download</button>
    },
    {
        name: "Wilkanoid 2",
        image: MWI,
        ...
        link : <button onClick ={()=>{downloadFile(WN)}}>Download</button>
    },
    {
        name: "Flips Adventrue",
        image: RII,
        ...
        link : <button onClick ={()=>{downloadFile(FA)}}>Download</button>
    },
    {
    ...
    },
    {
        ...
        link : <button onClick ={()=>{downloadFile(CS)}}>Download</button>
    },
];